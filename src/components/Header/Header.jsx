    ...
    <>
      <header className={`main-header ${isScrolled ? "scrolled" : ""} ${isHidden ? "hidden" : ""}`}>
        ...
        <nav className="nav-links">
          ...
          <HashLink smooth to='https://www.sysdevcode.com/'>Service</HashLink>
          <HashLink smooth to='https://www.sysdevcode.com/'>Academy</HashLink>
        ...
        <div className="header-actions">
          ...
          <a href="https://wa.me/7510991147" target="_blank" rel="noopener noreferrer" className="btn-whatsapp-header">
      ...
      <div className={`mobile-menu-drawer ${isMenuOpen ? "open" : ""}`}>
        ...
        <nav className="mobile-nav-links">
          <HashLink smooth to='#' onClick={toggleMenu}>Home</HashLink>
          <HashLink smooth to='https://www.sysdevcode.com/' onClick={toggleMenu}>Service</HashLink>
          <HashLink smooth to='https://www.sysdevcode.com/' onClick={toggleMenu}>Academy</HashLink>
          <HashLink smooth to='#pricing' onClick={toggleMenu}>Pricing</HashLink>
        </nav>
